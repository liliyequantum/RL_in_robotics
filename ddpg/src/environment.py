...
class Env():
    ...
    def setReward(self, done, arrive):
        ...
        if arrive:
            ...
            try:
                ...
                self.goal_position.position.x = random.uniform(-1.8, 1.8)
                self.goal_position.position.y = random.uniform(-1.8, 1.8)
    ...
    def reset(self):
        ...
        try:
            ...
            self.goal_position.position.x = random.uniform(-1.8, 1.8)
            self.goal_position.position.y = random.uniform(-1.8, 1.8)
            print("x: "+str(self.goal_position.position.x))
            print("y:"+str(self.goal_position.position.y))
